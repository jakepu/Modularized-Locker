...
CREATE TABLE `backup` (
  ...
  `occupied_email` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ID`,`Locker_Number`)
...
INSERT INTO `backup` VALUES ('100000000ca0824e',1,'124:223:161:5:121:170','NULL'),('100000000ca0824e',2,'124:223:161:15:137:118','NULL');
...
--
-- Dumping routines for database 'locker'
--
...
-- Dump completed on 2021-04-28 23:36:49
